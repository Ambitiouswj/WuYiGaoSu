    ...
    ui(new Ui::MediaPlayer)
{
    ...
    slider_Volume->setOrientation(Qt::Vertical);
     ui->pushButton_Volume->setIcon(QIcon("D:\\武易高速人车监测系统\\ICON\\音量.png"));
     ui->pushButton_Volume->setIconSize(QSize(40,40));
    //初始化不可用按钮
    ui->pushButton_Player->resize(20,20);
    ui->pushButton_Player->setEnabled(false);
    ui->pushButton_Player->setIcon(QIcon("D:\\武易高速人车监测系统\\ICON\\播放.png"));
    ui->pushButton_Player->setIconSize(QSize(40,40));
    ui->pushButton_Open->setIcon(QIcon("D:\\武易高速人车监测系统\\ICON\\打开视频.png"));
    ui->pushButton_Open->setIconSize(QSize(40,40));
...
void MediaPlayer::on_pushButton_Volume_clicked()
{
    if(state_slider_volume){
        ...
        slider_Volume->setGeometry((QRect(ui->pushButton_Volume->pos().rx()+
                                          ...
                                          ui->pushButton_Volume->y()-20,35,75)));
        slider_Volume->move(600,570);
        slider_Volume->show();
    }
...
{
    //选择视频文件
    //QString filename = QFileDialog::getOpenFileName(this,tr("选择视频文件"),"C:\\Users\\86188\\Desktop\\video\\1.mp4",
    ...
    ui->pushButton_Player->setIcon(QIcon("D:\\武易高速人车监测系统\\ICON\\暂停.png"));
    ui->pushButton_Player->setIconSize(QSize(40,40));
